...
run_step "[1/3] Downloading NPPES update..." "python3 $PROJECT/scrapers/nppes_downloader.py"
run_step "[2/3] Classifying..."              "python3 $PROJECT/scrapers/dso_classifier.py"
run_step "[3/3] Scoring..."                  "python3 $PROJECT/scrapers/merge_and_score.py"
