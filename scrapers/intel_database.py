...
def store_practice_intel(npi: str, research_data: Dict, db_path=None):
    ...
    try:
        ...
        obj = PracticeIntel(
            ...
            provider_count_web=prov.get("web_count"),
            owner_career_stage=prov.get("owner_stage"),
            provider_notes=prov.get("notes"),
            google_review_count=goog.get("reviews"),
            google_rating=goog.get("rating"),
            ...
            healthgrades_rating=hg.get("rating"),
            healthgrades_reviews=hg.get("reviews"),
