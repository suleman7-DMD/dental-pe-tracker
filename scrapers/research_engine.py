...
5. The `verification` block at the end is mandatory. Report exactly how many searches you executed, the queries used, your overall evidence quality, and the primary source URLs you cited. **`evidence_quality` MUST be exactly one of: "verified", "partial", "insufficient". NEVER use "high", "low", "medium", "sufficient", "good", "complete", or any other word — those will be coerced or rejected.**
