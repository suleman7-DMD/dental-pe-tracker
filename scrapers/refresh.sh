...
run_step "[2/8] Scraping PESP..."                "$PYTHON $PROJECT/scrapers/pesp_scraper.py"
run_step "[3/8] Scraping GDN..."                 "$PYTHON $PROJECT/scrapers/gdn_scraper.py"
run_step "[4/8] Importing PitchBook CSVs..."     "$PYTHON $PROJECT/scrapers/pitchbook_importer.py --auto"
run_step "[5/8] Scraping ADSO locations..."       "$PYTHON $PROJECT/scrapers/adso_location_scraper.py"
run_step "[6/8] Checking ADA HPI for updates..."  "$PYTHON $PROJECT/scrapers/ada_hpi_downloader.py"
run_step "[7/8] Classifying DSO affiliations..."  "$PYTHON $PROJECT/scrapers/dso_classifier.py"
run_step "[8/8] Merging and scoring..."           "$PYTHON $PROJECT/scrapers/merge_and_score.py"
