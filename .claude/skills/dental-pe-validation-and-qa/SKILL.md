...
| CI invariants / floors | `python3 scripts/check_data_invariants.py` (needs `SUPABASE_URL` + `SUPABASE_ANON_KEY` env) | FLOOR ≥268, FLOOR_NPI ≥1152, CENSUS ≥3692, CENSUS_NPI ≥8133, F02=0, F01=0; summary "0 failure(s)" |
...
SELECT COUNT(*) FROM practice_locations WHERE ownership_tier IS NOT NULL;   -- census (3692 @2026-07-09)
