...
| 10 | **1,178** | corp NPIs | 13,818 watched | `entity_classification IN (dso_regional,dso_national)` in SQLite (was 1,089 pre-Phase-4 Data-Axle, 875 pre-IL-seed); **Supabase still 875** until `practices` re-syncs | NPI-row corporate KPI = 8.53% SQLite / 6.33% live |
